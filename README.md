...
Demo admin login: `ibrheamshady@gmail.com` / `DemoGym2026!` (local demo mode only — the live password lives in the Supabase/CI secret, never in the repo) — demo code: `7Q2-K9D`
