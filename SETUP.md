...
هذا الدليل يشرح خطوات تشغيل نظام أكواد التفعيل **أونلاين** عبر Supabase Edge Functions، ورفع الموقع، وبناء تطبيق الأندرويد.
...
- لوحة الإدارة: بريد `ibrheamshady@gmail.com` وكلمة المرور `DemoGym2026!` (للنمط التجريبي فقط — السر الحقيقي في Supabase secret ولا يُنشر في الكود)
